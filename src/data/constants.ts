...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Contus - College Software Development Society",
    description: [
      "Led and organized a 3-day web development seminar for college students.",
      "Managed the 2-day 'Heist of Acropolis' web tech event, handling full website development.",
      "Organized recruitment events and mentoring sessions for junior developers.",
      "Coordinated multiple technical events and workshops, fostering coding culture on campus.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.NODEJS,
  ...
  },
  {
    ...
    description: [
      "Developed responsive NGO website for Mae Qual Foundation with donation and volunteer management.",
      "Built Rasoi Ki Rasoi restaurant website featuring online menu, ordering system, and location details.",
      "Created custom solutions for local businesses, improving their digital presence.",
      "Delivered clean, maintainable code with focus on user experience and performance.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.NODEJS,
